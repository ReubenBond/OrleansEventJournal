intellisense.annotate(jQuery, {
  ...
  'holdReady': function() {
    /// <signature>
    ///   <summary>Holds or releases the execution of jQuery's ready command.</summary>
...
intellisense.annotate(jQuery.Event.prototype, {
  'currentTarget': function() {
    /// <summary>The current DOM element within the command bubbling phase.</summary>
    /// <returns type="Element" />
  },
  'data': function() {
    /// <summary>An optional object of data passed to an command method when the current executing handler is bound.</summary>
    /// <returns type="Object" />
  },
  'delegateTarget': function() {
    /// <summary>The element where the currently-called jQuery command handler was attached.</summary>
    /// <returns type="Element" />
  },
  'isDefaultPrevented': function() {
    /// <summary>Returns whether command.preventDefault() was ever called on this command object.</summary>
    /// <returns type="Boolean" />
  },
  'isImmediatePropagationStopped': function() {
    /// <summary>Returns whether command.stopImmediatePropagation() was ever called on this command object.</summary>
    /// <returns type="Boolean" />
  },
  'isPropagationStopped': function() {
    /// <summary>Returns whether command.stopPropagation() was ever called on this command object.</summary>
    /// <returns type="Boolean" />
  },
  'metaKey': function() {
    /// <summary>Indicates whether the META key was pressed when the command fired.</summary>
    /// <returns type="Boolean" />
  },
  'namespace': function() {
    /// <summary>The namespace specified when the command was triggered.</summary>
    /// <returns type="String" />
  },
  'pageX': function() {
  ...
  'preventDefault': function() {
    /// <summary>If this method is called, the default action of the command will not be triggered.</summary>
  },
  'relatedTarget': function() {
    /// <summary>The other DOM element involved in the command, if any.</summary>
    /// <returns type="Element" />
  },
  'result': function() {
    /// <summary>The last value returned by an command handler that was triggered by this command, unless the value was undefined.</summary>
    /// <returns type="Object" />
  },
  'stopImmediatePropagation': function() {
    /// <summary>Keeps the rest of the handlers from being executed and prevents the command from bubbling up the DOM tree.</summary>
  },
  'stopPropagation': function() {
    /// <summary>Prevents the command from bubbling up the DOM tree, preventing any parent handlers from being notified of the command.</summary>
  },
  'target': function() {
    /// <summary>The DOM element that initiated the command.</summary>
    /// <returns type="Element" />
  },
  'timeStamp': function() {
    /// <summary>The difference in milliseconds between the time the browser created the command and January 1, 1970.</summary>
    /// <returns type="Number" />
  },
  'type': function() {
    /// <summary>Describes the nature of the command.</summary>
    /// <returns type="String" />
  },
  'which': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'ajaxComplete': function() {
    ...
    ///   <param name="handler(command, XMLHttpRequest, ajaxOptions)" type="Function">The function to be invoked.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'ajaxError': function() {
    ...
    ///   <param name="handler(command, jqXHR, ajaxSettings, thrownError)" type="Function">The function to be invoked.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'ajaxSend': function() {
    ...
    ///   <param name="handler(command, jqXHR, ajaxOptions)" type="Function">The function to be invoked.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'ajaxStart': function() {
  ...
  'bind': function() {
    /// <signature>
    ///   <summary>Attach a handler to an command for the elements.</summary>
    ///   <param name="eventType" type="String">A string containing one or more DOM command types, such as "click" or "submit," or custom command names.</param>
    ///   <param name="eventData" type="Object">An object containing data that will be passed to the command handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Attach a handler to an command for the elements.</summary>
    ///   <param name="eventType" type="String">A string containing one or more DOM command types, such as "click" or "submit," or custom command names.</param>
    ///   <param name="eventData" type="Object">An object containing data that will be passed to the command handler.</param>
    ///   <param name="preventBubble" type="Boolean">Setting the third argument to false will attach a function that prevents the default action from occurring and stops the command from bubbling. The default is true.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Attach a handler to an command for the elements.</summary>
    ///   <param name="events" type="Object">An object containing one or more DOM command types and functions to execute for them.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'blur': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "blur" JavaScript command, or trigger that command on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'change': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "change" JavaScript command, or trigger that command on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'click': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "click" JavaScript command, or trigger that command on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'clone': function() {
    ...
    ///   <param name="withDataAndEvents" type="Boolean">A Boolean indicating whether command handlers should be copied along with the elements. As of jQuery 1.4, element data will be copied as well.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Create a deep copy of the set of matched elements.</summary>
    ///   <param name="withDataAndEvents" type="Boolean">A Boolean indicating whether command handlers and data should be copied along with the elements. The default value is false. *In jQuery 1.5.0 the default value was incorrectly true; it was changed back to false in 1.5.1 and up.</param>
    ///   <param name="deepWithDataAndEvents" type="Boolean">A Boolean indicating whether command handlers and data for all children of the cloned element should be copied. By default its value matches the first argument's value (which defaults to false).</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'closest': function() {
  ...
  'dblclick': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "dblclick" JavaScript command, or trigger that command on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'delegate': function() {
    ...
    ///   <param name="selector" type="String">A selector to filter the elements that trigger the command.</param>
    ///   <param name="eventType" type="String">A string containing one or more space-separated JavaScript command types, such as "click" or "keydown," or custom command names.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute at the time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Attach a handler to one or more events for all elements that match the selector, now or in the future, based on a specific set of root elements.</summary>
    ...
    ///   <summary>Attach a handler to one or more events for all elements that match the selector, now or in the future, based on a specific set of root elements.</summary>
    ///   <param name="selector" type="String">A selector to filter the elements that trigger the command.</param>
    ///   <param name="events" type="PlainObject">A plain object of one or more command types and functions to execute for them.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'dequeue': function() {
  ...
  'die': function() {
    /// <signature>
    ///   <summary>Remove command handlers previously attached using .live() from the elements.</summary>
    ///   <param name="eventType" type="String">A string containing a JavaScript command type, such as click or keydown.</param>
    ///   <param name="handler" type="String">The function that is no longer to be executed.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove command handlers previously attached using .live() from the elements.</summary>
    ///   <param name="events" type="PlainObject">A plain object of one or more command types, such as click or keydown and their corresponding functions that are no longer to be executed.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'disabled': function() {
  ...
  'error': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "error" JavaScript command.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute when the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Bind an command handler to the "error" JavaScript command.</summary>
  ...
  'focus': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "focus" JavaScript command, or trigger that command on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'focusin': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "focusin" command.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'focusout': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "focusout" JavaScript command.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'keydown': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "keydown" JavaScript command, or trigger that command on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Bind an command handler to the "keydown" JavaScript command, or trigger that command on an element.</summary>
    ///   <param name="eventData" type="PlainObject">An object containing data that will be passed to the command handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'keypress': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "keypress" JavaScript command, or trigger that command on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'keyup': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "keyup" JavaScript command, or trigger that command on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'live': function() {
    /// <signature>
    ///   <summary>Attach an command handler for all elements which match the current selector, now and in the future.</summary>
    ///   <param name="events" type="String">A string containing a JavaScript command type, such as "click" or "keydown." As of jQuery 1.4 the string can contain multiple, space-separated command types or custom command names.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute at the time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Attach an command handler for all elements which match the current selector, now and in the future.</summary>
    ///   <param name="events" type="String">A string containing a JavaScript command type, such as "click" or "keydown." As of jQuery 1.4 the string can contain multiple, space-separated command types or custom command names.</param>
    ///   <param name="data" type="PlainObject">An object containing data that will be passed to the command handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute at the time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Attach an command handler for all elements which match the current selector, now and in the future.</summary>
    ///   <param name="events" type="PlainObject">A plain object of one or more JavaScript command types and functions to execute for them.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'load': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "load" JavaScript command.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute when the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'mousedown': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "mousedown" JavaScript command, or trigger that command on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'mouseenter': function() {
    /// <signature>
    ///   <summary>Bind an command handler to be fired when the mouse enters an element, or trigger that handler on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'mouseleave': function() {
    /// <signature>
    ///   <summary>Bind an command handler to be fired when the mouse leaves an element, or trigger that handler on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'mousemove': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "mousemove" JavaScript command, or trigger that command on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'mouseout': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "mouseout" JavaScript command, or trigger that command on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'mouseover': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "mouseover" JavaScript command, or trigger that command on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'mouseup': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "mouseup" JavaScript command, or trigger that command on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'off': function() {
    /// <signature>
    ///   <summary>Remove an command handler.</summary>
    ///   <param name="events" type="String">One or more space-separated command types and optional namespaces, or just namespaces, such as "click", "keydown.myPlugin", or ".myPlugin".</param>
    ///   <param name="selector" type="String">A selector which should match the one originally passed to .on() when attaching command handlers.</param>
    ///   <param name="handler(eventObject)" type="Function">A handler function previously attached for the command(s), or the special value false.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove an command handler.</summary>
    ///   <param name="events" type="PlainObject">An object where the string keys represent one or more space-separated command types and optional namespaces, and the values represent handler functions previously attached for the command(s).</param>
    ///   <param name="selector" type="String">A selector which should match the one originally passed to .on() when attaching command handlers.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'on': function() {
    /// <signature>
    ///   <summary>Attach an command handler function for one or more events to the selected elements.</summary>
    ///   <param name="events" type="String">One or more space-separated command types and optional namespaces, such as "click" or "keydown.myPlugin".</param>
    ///   <param name="selector" type="String">A selector string to filter the descendants of the selected elements that trigger the command. If the selector is null or omitted, the command is always triggered when it reaches the selected element.</param>
    ///   <param name="data" type="Anything">Data to be passed to the handler in command.data when an command is triggered.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute when the command is triggered. The value false is also allowed as a shorthand for a function that simply does return false.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Attach an command handler function for one or more events to the selected elements.</summary>
    ///   <param name="events" type="PlainObject">An object in which the string keys represent one or more space-separated command types and optional namespaces, and the values represent a handler function to be called for the command(s).</param>
    ...
    ///   <param name="data" type="Anything">Data to be passed to the handler in command.data when an command occurs.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'one': function() {
    /// <signature>
    ///   <summary>Attach a handler to an command for the elements. The handler is executed at most once per element.</summary>
    ///   <param name="events" type="String">A string containing one or more JavaScript command types, such as "click" or "submit," or custom command names.</param>
    ///   <param name="data" type="PlainObject">An object containing data that will be passed to the command handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute at the time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'resize': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "resize" JavaScript command, or trigger that command on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'scroll': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "scroll" JavaScript command, or trigger that command on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'select': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "select" JavaScript command, or trigger that command on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'submit': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "submit" JavaScript command, or trigger that command on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'trigger': function() {
    /// <signature>
    ///   <summary>Execute all handlers and behaviors attached to the matched elements for the given command type.</summary>
    ///   <param name="eventType" type="String">A string containing a JavaScript command type, such as click or submit.</param>
    ///   <param name="extraParameters" type="">Additional parameters to pass along to the command handler.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Execute all handlers and behaviors attached to the matched elements for the given command type.</summary>
    ///   <param name="command" type="Event">A jQuery.Event object.</param>
    ///   <param name="extraParameters" type="">Additional parameters to pass along to the command handler.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'triggerHandler': function() {
    /// <signature>
    ///   <summary>Execute all handlers attached to an element for an command.</summary>
    ///   <param name="eventType" type="String">A string containing a JavaScript command type, such as click or submit.</param>
    ///   <param name="extraParameters" type="Array">An array of additional parameters to pass along to the command handler.</param>
    ///   <returns type="Object" />
    /// </signature>
  },
  'unbind': function() {
    /// <signature>
    ///   <summary>Remove a previously-attached command handler from the elements.</summary>
    ///   <param name="eventType" type="String">A string containing a JavaScript command type, such as click or submit.</param>
    ...
    /// <signature>
    ///   <summary>Remove a previously-attached command handler from the elements.</summary>
    ///   <param name="command" type="Object">A JavaScript command object as passed to an command handler.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'undelegate': function() {
    /// <signature>
    ///   <summary>Remove a handler from the command for all elements which match the current selector, based upon a specific set of root elements.</summary>
    ///   <param name="selector" type="String">A selector which will be used to filter the command results.</param>
    ///   <param name="eventType" type="String">A string containing a JavaScript command type, such as "click" or "keydown"</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ...
    ///   <summary>Remove a handler from the command for all elements which match the current selector, based upon a specific set of root elements.</summary>
    ///   <param name="selector" type="String">A selector which will be used to filter the command results.</param>
    ///   <param name="events" type="PlainObject">An object of one or more command types and previously bound functions to unbind from them.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove a handler from the command for all elements which match the current selector, based upon a specific set of root elements.</summary>
  ...
  'unload': function() {
    /// <signature>
    ///   <summary>Bind an command handler to the "unload" JavaScript command.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute when the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Bind an command handler to the "unload" JavaScript command.</summary>
    ///   <param name="eventData" type="Object">A plain object of data that will be passed to the command handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the command is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
